...
const menuItems = ref([
   ...
   { name: 'Данные компании', path: '/company', icon: 'briefcase', group: 'Основное' },
   { name: 'Сотрудники', path: '/employees', icon: 'users', group: 'Основное' },
   { name: 'Страны', path: '/countries', icon: 'globe', group: 'Основное' },
   { name: 'Города', path: '/cities', icon: 'city', group: 'Основное' },
   { name: 'Графики работы', path: '/restaurant-schedules', icon: 'clock', group: 'Основное' },
   { name: 'Рестораны', path: '/restaurants', icon: 'restaurant', group: 'Основное' },
   { name: 'Зоны доставки', path: '/delivery-zones', icon: 'map', group: 'Основное' },
   { name: 'Категории', path: '/categories', icon: 'tag', group: 'Основное' },
   { name: 'Товары', path: '/products', icon: 'box', group: 'Основное' },
   { name: 'Правовые документы', path: '/legal-documents', icon: 'document', group: 'Основное' },
   { name: 'Дизайн', path: '/designs', icon: 'palette', group: 'Основное' },
