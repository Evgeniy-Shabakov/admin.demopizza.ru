   ...
   <aside :class="[
      ...
      <div class="flex-1 overflow-y-auto">
         <nav class="p-4 space-y-2">
            ...
            <div v-for="group in menuGroups.groups"
                 :key="group.name"
                 class="space-y-1 lg:relative group">
      ...
      <div class="shrink-0 p-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
         <button @click="logout"
