...
<template>
   <aside :class="[
      'fixed left-0 top-0 z-40 h-screen w-72 md:w-64 bg-white dark:bg-gray-800 border-r border-b border-gray-200 dark:border-gray-700 transition-transform duration-300 lg:translate-x-0',
