...
<template>
  <div class="space-y-6">
    ...
    <div>
      <BaseLabel for="restaurant-address">Адрес (улица, дом)</BaseLabel>
      <BaseInput
        v-if="disabled && restaurant"
        id="restaurant-address"
        :model-value="restaurant.address.addressAsString"
        type="text"
        disabled
      />
      <BaseInput
    ...
    <div v-if="showDetails && restaurant">
      ...
      <BaseInput
        ...
        :model-value="formatDateTime(restaurant.createdAt)"
        type="text"
        disabled
      />
    </div>
    ...
    <div v-if="showDetails && restaurant">
      ...
      <BaseInput
        ...
        :model-value="formatDateTime(restaurant.updatedAt)"
        type="text"
        disabled
      />
    </div>
