...
const menuItems = ref([
   ...
   { name: 'Данные компании', path: '/company', icon: 'briefcase', group: 'Настройки' },
   { name: 'Сотрудники', path: '/employees', icon: 'users', group: 'Настройки' },
   { name: 'Страны', path: '/countries', icon: 'globe', group: 'Настройки' },
   { name: 'Города', path: '/cities', icon: 'city', group: 'Настройки' },
   { name: 'Графики работы', path: '/restaurant-schedules', icon: 'clock', group: 'Настройки' },
   { name: 'Рестораны', path: '/restaurants', icon: 'restaurant', group: 'Настройки' },
   { name: 'Зоны доставки', path: '/delivery-zones', icon: 'map', group: 'Настройки' },
   { name: 'Категории', path: '/categories', icon: 'tag', group: 'Настройки' },
   { name: 'Товары', path: '/products', icon: 'box', group: 'Настройки' },
   { name: 'Правовые документы', path: '/legal-documents', icon: 'document', group: 'Настройки' },
   { name: 'Дизайн', path: '/designs', icon: 'palette', group: 'Настройки' },
